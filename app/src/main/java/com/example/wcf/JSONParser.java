    ...
    public JSONObject makeHttpRequest(String url, String method,
        ...
        try {
            ...
            if(method.equals("POST")){
                ...
                //add to resolve scheme socket error
                //CommonsHttpOAuthProvider httpOauthprovider = new CommonsHttpOAuthProvider()
               // httpClient.getConnectionManager().getSchemeRegistry().register(
                //        new Scheme("https", SSLSocketFactory.getSocketFactory(), 3306)
                //);
